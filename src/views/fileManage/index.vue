<template>
  <div class="app-container">
    ...
    >
      <el-table-column :label="$t('ID')" prop="id" sortable align="center" width="65">
        <template slot-scope="scope">
          <span>{{ scope.row.id }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('磁盘路径')" min-width="110px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.path }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('网络路径')" min-width="80px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.url}}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('大小')" prop="status" sortable width="80px" align="center">
        <template slot-scope="scope">
          <span >{{scope.row.size}}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('文件格式')" prop="expireDate" sortable class-name="status-col" width="150px">
        <template slot-scope="scope">
...
<script>
import { getFiles} from '@/api/file/fileManage'
